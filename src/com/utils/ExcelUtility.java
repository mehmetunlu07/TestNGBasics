...
public class ExcelUtility {
	...
	public static Object[][] excelIntoArray(String filePath, String sheetName) {
		...
		Object[][] data = new Object[rows - 1][cols];//header satirini array e almayacagimiz icin -1
		...
		for (int i = 1; i < rows; i++) {
			...
			for (int j = 0; j < cols; j++) {
				data[i - 1][j] = cellData(i, j);  //sifirinci indexten itibaren kayit icin data[i - 1][j]
			}
		}
